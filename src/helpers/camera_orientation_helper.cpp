  ...
  length_(length)
{
	...
	lineUp->setDrawMode(MESH_DRAW_MODE_LINE);
	lineUp->setDrawItem(MESH_DRAW_ITEM_ARRAY);
	lineLeft->setDrawMode(MESH_DRAW_MODE_LINE);
	lineLeft->setDrawItem(MESH_DRAW_ITEM_ARRAY);
	lineForward->setDrawMode(MESH_DRAW_MODE_LINE);
	lineForward->setDrawItem(MESH_DRAW_ITEM_ARRAY);
