...
Geometry Geometry::Box(float width, float height, float depth, int widthSegments, int heightSegments, int depthSegments) {
    Geometry geometry;
...
Geometry Geometry::Sphere(float radius, uint widthSegments, uint heightSegments, float phiStart, float phiLength,
...
Geometry Geometry::Cylinder(float radiusTop, float radiusBottom, float height, uint radialSegments, uint heightSegments,
...
Geometry
Geometry::Cone(float radius, float height, uint radialSegments, uint heightSegments, bool openEnded, float thetaStart,
               float thetaLength) {
    return Geometry::Cylinder(0.0f, radius, height, radialSegments, heightSegments, openEnded, thetaStart, thetaLength);
}

Geometry Geometry::Ring(float innerRadius, float outerRadius, uint thetaSegments, uint phiSegments, float thetaStart,
                        float thetaLength) {
    Geometry geometry;
